...
public interface RemoteControlActivityConstants {
	...
	public static String PATHMOSAICHORIZONTAL = "/skins/mosaichorizontal";
	public static String PATHMOSAICVERTICAL = "/skins/mosaicvertical";
	public static String PATHREMOTEHORIZONTAL = "/skins/remotehorizontal";
	public static String PATHREMOTEVERTICAL = "/skins/remotevertical";
	
	public static String PATHMOSAICSDCARD = "/.skins/mosaic";
