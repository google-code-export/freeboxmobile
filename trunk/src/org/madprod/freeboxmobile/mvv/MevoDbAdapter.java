...
public class MevoDbAdapter implements MevoConstants
{
	 ...
	 */
	// TODO : Utiliser les constantes de MevoConstantes lра dedans...
...
//		Log.d(TAG,"DATABASE PATH : "+ctx.getDatabasePath("tptp"));
	 ...
	 */
	public MevoDbAdapter open() throws SQLException
	{
...
//		return dest;
	...
	/**
	 * Met ра jour une valeur int d'un message
	 * @param name nom du fichier du message
	 * @param k    colonne ра mettre ра jour
	 * @param val  valeur ра mettre ра jour
